  ...
  return (
    <>
        ...
        <div style={background2style} class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
            <div className="rounded overflow-hidden shadow-lg w3-animate-left">
            ...
            <div className="rounded overflow-hidden shadow-lg w3-animate-bottom">
            ...
            <div className="rounded overflow-hidden shadow-lg w3-animate-right">
