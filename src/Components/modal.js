...
function Modal() {
  ...
  return (
    <>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-2 justify-center p-5" >
        <div className="flex justify-center text-4xl rounded-xl p-3 bg-gray-100 cursor-pointer hover:bg-gray-300 transform transition duration-350 hover:scale-105">
            <img src="https://pbs.twimg.com/media/Do73TSDU4AEgQLr.jpg" alt="1" onClick={() => setShowModal(true)} />
        </div>
      </div>
      {showModal ? (
        <>
